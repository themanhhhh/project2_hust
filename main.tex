...
\begin{itemize}
    ...
    \item \textbf{Về yêu cầu phi chức năng:} Hệ thống phải đảm bảo hiệu năng cao, khả năng mở rộng, bảo mật thông tin giao dịch, tính khả dụng và tối ưu SEO/GEO.
    
    \item \textbf{Về tác nhân:} Hệ thống phục vụ 4 nhóm tác nhân chính gồm khách hàng, quản trị viên, hệ thống thanh toán và đơn vị vận chuyển.
...
\begin{enumerate}
    \item \textbf{Xây dựng nền tảng TMĐT chuyên biệt cho ngành cầu lông:} Phát triển hệ thống hỗ trợ quản lý sản phẩm theo nhiều biến thể kỹ thuật (trọng lượng, độ cứng, điểm cân bằng, kích thước), giúp người dùng dễ dàng tra cứu, so sánh và lựa chọn sản phẩm phù hợp với trình độ và phong cách chơi.
    ...
    \item \textbf{Tối ưu hóa SEO và GEO:} Áp dụng các kỹ thuật tối ưu SEO (cấu trúc URL thân thiện, meta tags, schema markup, tốc độ tải trang) và GEO (nội dung có cấu trúc rõ ràng, đáng tin cậy) nhằm tăng khả năng hiển thị trên công cụ tìm kiếm truyền thống và các hệ thống AI sinh nội dung.
...
Hệ thống SmashX được xây dựng theo mô hình \textbf{B2C (Business-to-Consumer)}, trong đó một công ty tư nhân đóng vai trò là đơn vị kinh doanh duy nhất, trực tiếp cung cấp sản phẩm đến tay người tiêu dùng cuối cùng. Khác với mô hình marketplace (C2C hoặc B2B2C) như Shopee hay Lazada -- nơi nhiều nhà bán cùng hoạt động trên một sàn chung, mô hình B2C của SmashX cho phép doanh nghiệp toàn quyền kiểm soát chất lượng sản phẩm, chính sách giá, thương hiệu và trải nghiệm khách hàng. Điều này đặc biệt phù hợp với ngành hàng cầu lông, nơi tính chính hãng, tư vấn chuyên sâu và uy tín thương hiệu là yếu tố then chốt ảnh hưởng đến quyết định mua hàng.

Với mô hình B2C, hệ thống tập trung vào hai nhóm tác nhân chính: (i) \textbf{phía doanh nghiệp} gồm quản trị viên (Admin) quản lý toàn bộ hệ thống, nhân viên bán hàng (Seller) quản lý sản phẩm và đơn hàng, bộ phận vận hành giao nhận (Fulfillment); và (ii) \textbf{phía khách hàng} gồm khách vãng lai (Guest) và khách hàng đã đăng ký (Customer). Sơ đồ use case tổng quát dưới đây mô tả các kịch bản tương tác quan trọng giữa các tác nhân và hệ thống.\\ \textit{Kịch bản use case chi tiết} được trình bày ở phần sau.
\begin{figure}[H]
\centering
